  ...
  categories: [
    {
      id: "engagement-decor",
      name: "订婚布置",
      nameEn: "ENGAGEMENT DECOR",
      icon: "ring",
      description: "中式轻奢订婚氛围感布置，从花艺到灯光，打造属于你们的浪漫仪式场景",
      items: [],
    },
    {
      id: "birthday-decor",
      name: "周岁宴布置",
      nameEn: "1ST BIRTHDAY DECOR",
      icon: "baby",
      description: "宝宝周岁专属仪式场景布置，抓周道具、背景气球、主题定制一站式完成",
      items: [],
    },
    {
      id: "wedding-photo",
      ...
      icon: "camera",
      description: "婚礼全程纪实摄影跟拍，捕捉每一个动人瞬间，高清精修按时交付",
      items: [],
    },
    {
      id: "event-photo",
      ...
      nameEn: "EVENT PHOTO",
      icon: "event",
      description: "开业典礼、年会、发布会等商业活动全程摄影跟拍记录",
      items: [],
    },
    {
      id: "birthday-photo",
      name: "周岁宴跟拍",
      nameEn: "1ST BIRTHDAY PHOTO",
      icon: "cake",
      description: "宝宝周岁宴全程纪实跟拍，记录抓周、庆生每一个珍贵时刻",
      items: [],
    },
    {
      id: "engagement-photo",
      name: "订婚宴跟拍",
      nameEn: "ENGAGEMENT PHOTO",
      icon: "bouquet",
      description: "订婚宴全程纪实跟拍，定格交换信物、甜蜜合影等浪漫画面",
      items: [],
    },
    {
      id: "wedding-video",
      name: "婚礼视频拍摄",
      nameEn: "WEDDING VIDEO",
      icon: "video",
      description: "婚礼全程视频录制与精剪，多机位记录，交付婚礼全程纪录片",
      items: [],
    },
    {
      id: "prewedding-film",
      name: "婚前微电影拍摄",
      nameEn: "PRE-WEDDING FILM",
      icon: "film",
      description: "定制婚前爱情微电影，剧本策划、场景拍摄、专业后期剪辑，打造专属爱情故事",
      items: [],
    },
  ],
...
const ICONS = {
  ...
  film: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="4" width="20" height="16" rx="2"/><line x1="2" y1="8" x2="22" y2="8"/><line x1="2" y1="12" x2="22" y2="12"/><line x1="2" y1="16" x2="22" y2="16"/><path d="M8 4v4M16 4v4M8 16v4M16 16v4"/></svg>',
};
